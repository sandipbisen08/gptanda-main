      ...
      <section className="services-provided">
        <div className="container">
          ...
          <div className="services-grid">
            ...
            <div className="service-card">
              <h3>निवास प्रमाणपत्र</h3>
              <p>गावातील निवास प्रमाणपत्र जारी करणे</p>
            </div>
            <div className="service-card">
              <h3>आय प्रमाणपत्र</h3>
              <p>कमजोर वर्गांसाठी आय प्रमाणपत्र जारी करणे</p>
            </div>
            <div className="service-card">
              <h3>जाती प्रमाणपत्र</h3>
              <p>अनुसूचित जाती/जनजाती प्रमाणपत्र जारी करणे</p>
            </div>
            <div className="service-card">
              <h3>विविध अर्ज</h3>
